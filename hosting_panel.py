...
# Process tracking dictionary: { "filename": Popen_Object }
RUNNING_PROCESSES = {}
...
def dashboard():
    ...
    <body class="bg-gray-950 text-gray-100 font-sans min-h-screen flex flex-col justify-between">
                ...
                <div class="max-w-4xl mx-auto flex justify-between items-center">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <span class="text-[10px] text-gray-400 tracking-wider">CLOUD PROCESS ENGINE</span>
                        </div>
                    </div>
        ...
        <footer class="text-center py-4 text-xs text-gray-600 border-t border-gray-900 mt-6">
            TOXIC HOSTING PANEL &bull; Powered by Render
        </footer>
